...
hmenu = Section.create_section(section_piece_hash['container'].id, {:title=>"hmenu"},
...
vmenu = Section.create_section(section_piece_hash['container'].id, {:title=>"vmenu"},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
...
logo = Section.create_section(section_piece_hash['container'].id, {:title=>"logo"},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
...
text = Section.create_section(section_piece_hash['container'].id, {:title=>"text"},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
text.add_section_piece(section_piece_hash['text'].id)

blog_post_title = Section.create_section(section_piece_hash['container'].id, {:title=>"blog post title"},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
blog_post_title.add_section_piece(section_piece_hash['blog-post-title'].id)

blog_post_body = Section.create_section(section_piece_hash['container'].id, {:title=>"blog post body"},
  {'block'=>{'disabled_ha_ids'=>'111'},
   'content_horizontal'=>{'disabled_ha_ids'=>'101'},
   'inner'=>{'15hidden'=>bool_true}})
