...
ah =  { "editor_id"=>3, "class_name"=>"s_ah", "pclass"=>"css", "param_category_id"=>12,  "html_attribute_ids"=>"2,3,4,5"}  
...
ah =  { "editor_id"=>4,  "class_name"=>"s_ah", "pclass"=>"css", "param_category_id"=>12,  "html_attribute_ids"=>"24,27,49,53,54"}  
create_section_piece_param( section_piece, a)
create_section_piece_param( section_piece, ah)
